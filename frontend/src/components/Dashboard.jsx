              ...
              <div className={styles.courseDetailsContainer}>
                ...
                <div className={styles.studentActions}>
                  {cameraStarted ? (
                    ...
                    <button className={styles.attendanceButton} onClick={handleTakeAttendance}>Start Camera</button>
                  )}
                  <button className={styles.attendanceButton} onClick={() => handleViewAttendance(selectedCourse)}>View Attendance</button>
                </div>
